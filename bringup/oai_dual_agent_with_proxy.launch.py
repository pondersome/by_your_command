#!/usr/bin/env python3
"""
OpenAI Dual Agent Launch File WITH REFLECTION PROXY
...
def generate_launch_description():
    ...
    conv_agent_config = os.path.join(pkg_dir, 'config', 'oai_realtime_agent_proxy.yaml')
    cmd_agent_config = os.path.join(pkg_dir, 'config', 'oai_command_agent_proxy.yaml')
    ...
    return LaunchDescription([
        ...
        # Reflection proxy (must start first, not namespaced)
        reflection_proxy,
